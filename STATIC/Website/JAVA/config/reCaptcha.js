...
async function createAssessment({
  ...
  projectID = "pdubbs-solutions",
  recaptchaKey = "6Ld7810qAAAAAKab62SKEisZ0KwLOvFJo-Vg0MFV",
  token = "action-token",
...
async function createPasswordLeakAssessment(
    ...
    const createAssessmentRequest = {
        ...
        assessment:{
            privatePasswordLeakVerification:{
                lookupHashPerfix: lookupHashPerfix,
    ...
    const [response] = await client.createAssessment(createAssessmentRequest);
        ...
        if (!response.privatePasswordLeakVerification)
            throw 'Error in obtaining response from Priate Password Leak Verification ${response}';
    }
...
exports.createPasswordLeakAssessment = createPasswordLeakAssessment;
